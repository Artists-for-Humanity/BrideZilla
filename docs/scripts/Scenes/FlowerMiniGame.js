...
export default class FlowerMiniGame extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("deadpetal", new URL("../../assets/deadpetal.png", import.meta.url).href);
    this.load.image("trashcan", new URL("../../assets/trashcan.png", import.meta.url).href);
  }
  create() {
  ...
  setFlowerPetals() {
    ...
    for (let i = 0; i < this.numPetals; i++) {
      ...
      this.deadpetals.create(x2, y2, "deadpetal").setScale(0.9, 0.9).rotation += r;
    }
  }
}
